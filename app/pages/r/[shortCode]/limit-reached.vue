<template>
  <div class="flex min-h-screen items-center justify-center bg-muted-50 dark:bg-muted-900">
    <div class="w-full max-w-md space-y-6 rounded-lg border bg-white p-8 text-center shadow-lg dark:bg-muted-800">
      <Icon name="lucide:trending-up" class="mx-auto h-16 w-16 text-muted-400" />
      <div>
        <h1 class="text-2xl font-bold">Click Limit Reached</h1>
        <p class="mt-2 text-muted-foreground">This link has reached its maximum number of clicks and is no longer available.</p>
      </div>
      <NuxtLink
        to="/"
